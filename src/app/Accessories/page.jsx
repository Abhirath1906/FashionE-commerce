...
export default function AccPage({onBuy}) {
    ...
    return (
        <div className="woman-container">
            <Divider />
            <h2 className="woman-title">Accessories Collection</h2>
                    ...
                    {filteredData.map((item, index) => (
                        ...
                        >
                            ...
                            >
                                ...
                                <p className="accessories-price" style={{ fontWeight: 600 }}>
